...
export default {
  openFilesView: null,
	config: {
		...
		sortOrder: {
			title: 'Sort Order',
			description: 'Indicate the order of the criteria for the sorting of the open files list, separated by commas. Options: base, ext, dir, time',
			type: 'string',
			default: 'base, ext, dir, time'
		}
	},
