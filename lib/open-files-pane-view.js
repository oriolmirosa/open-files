...
export default class OpenFilesPaneView {
	constructor() {
		...
		let self = this
		$(this.element).on('click', '.list-item[is=tree-view-file-open-files]', function() {
	...
	setPane(pane) {
		...
		this.paneSub.add(pane.observeItems).then(item => {
			let listItem = document.createElement('li');
			listItem.classList.add('file', 'list-item');
			listItem.setAttribute('is', 'tree-view-file-open-files');
